...
pub mod serialization {
    ...
    pub fn api_surface() -> &'static str {
        "artop-artop-runtime::serialization"
    }
}
...
pub mod deserialization {
    ...
    /// Placeholder marker so the module compiles until the real port lands.
    pub fn api_surface() -> &'static str {
        "artop-artop-runtime::deserialization"
    }
}
...
pub mod resource_factory {
    ...
    /// Placeholder marker so the module compiles until the real port lands.
    pub fn api_surface() -> &'static str {
        "artop-artop-runtime::resource_factory"
    }
}
...
pub mod version_metadata {
    ...
    /// Placeholder marker so the module compiles until the real port lands.
    pub fn api_surface() -> &'static str {
        "artop-artop-runtime::version_metadata"
    }
}
...
pub mod autosar_metamodel {
    ...
    /// Placeholder marker so the module compiles until the real port lands.
    pub fn api_surface() -> &'static str {
        "artop-artop-runtime::autosar_metamodel"
    }
}
