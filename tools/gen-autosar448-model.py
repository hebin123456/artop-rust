#!/usr/bin/env python3
"""Regenerate `crates/emf-artop/autosar448-model/src/registry.rs` from an AUTOSAR `.ecore`.

Usage:
    python3 tools/gen-autosar448-model.py <path-to-autosar448.ecore> [out.rs]
...
def gen(ecore_path):
    ...
    out = ["// AUTO-GENERATED from autosar448.ecore — do not edit (run tools/gen-autosar448-model.py)"]
